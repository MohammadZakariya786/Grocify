...
const Discount = () => {
  ...
  return (
    ...
    <div className='md:bg-transparent bg-zinc-100 overflow-x-hidden flex md:flex-row flex-col max-w-[1400px] px-10 py-10 mx-auto'>
            <span className='text-orange-500 md:text-9xl text-6xl font-bold h-fit md:self-center transform md:-rotate-90'>20%</span>
